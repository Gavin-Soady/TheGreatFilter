    ...
    Column(modifier = modifier) {
        ...
        Row(
            ...
            TextField(
                ...
                colors = TextFieldDefaults.textFieldColors(textColor = androidx.compose.ui.graphics.Color.Black)
            )
        }
...
//                modifier = Modifier.height(150.dp).background(androidx.compose.ui.graphics.Color.Transparent),
//                colors = TextFieldDefaults.textFieldColors(textColor = androidx.compose.ui.graphics.Color.Black),
//                singleLine = false
//            )
//        }
